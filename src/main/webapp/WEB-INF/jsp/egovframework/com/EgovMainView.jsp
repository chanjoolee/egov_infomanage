...
<div>
	...
	<!-- 차트 -->
	<h3 class="m_tit01 mt15">차트</h3>
	<div class="mp_bn">
		<script src="/chart/d3.min.js"></script>
		<script src="/chart/billboard.js"></script>
		<link rel="stylesheet" href="/chart/billboard.css">
		<link rel="stylesheet" href="/chart/insight.min.css">
		<div id="chart"></div>
		<script>
